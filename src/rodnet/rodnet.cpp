...
const double dz[FISH_CLASS_NUM] = {0.669806255844, 0.741064762661,
                                   0.857597614315, 1.328272472136,
                                   1.186279270937, 1.323759268516,
                                   1.335876613618, 1.136183018284},
             theta[3][FISH_CLASS_NUM] =
                 {{0.097528072938, 0.245478327606, -0.210822452891,
                  ...
                  {0.615099030109, -0.068102505942, 0.254708168102,
                   ...
                   -1.061870072053, -1.052920215923, -0.644808391282}},
             B[3] = {0.899886033474, 1.765940878633,
                     -2.538361514987};  // fitted parameters

const double offset[FISH_CLASS_NUM] = {0.3, 0, 0.2, 0, 0.1, 0.1, 0.1, 0};
